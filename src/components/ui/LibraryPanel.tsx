    ...
    <div className="flex flex-col h-full bg-card text-foreground select-none text-xs">
      ...
      <div className="p-3 border-b border-border space-y-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-secondary text-foreground pl-8 pr-3 py-1.5 rounded-lg border border-border outline-none focus:border-blue-500 text-xs transition-colors"
          />
        </div>
      ...
      <div className="p-3 border-t border-border bg-secondary/20">
        <button
          ...
          className="w-full py-2 px-3 border border-dashed border-border hover:border-foreground/40 rounded-xl text-xs text-muted-foreground hover:text-foreground flex items-center justify-center space-x-1.5 transition-colors cursor-pointer"
        >
